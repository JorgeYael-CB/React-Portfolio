  ...
  return (
    <div className="flex flex-col items-center">
      <span className="text-sm text-gray-700 dark:text-gray-400">
          Showing <span className="font-semibold text-gray-900"> {currentPage + 1} </span> to <span className="font-semibold text-gray-900">{ currentElements }</span> of <span className="font-semibold text-gray-900">{ allElementsNumber }</span> Entries
      </span>
